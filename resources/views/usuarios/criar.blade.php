...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('u-cadastrar') }}" method="POST">
                @csrf
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <label for="uf" class="form-label">Responsável Familiar</label>
                            <select name="rf" id="rf" class="form-control">
                                <option value="">Selecione um Responsável Familiar</option>
                            </select>
                        </div>
                    </div>
